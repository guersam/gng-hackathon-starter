...
export const yoilManifest = {
  ...
  finalePlan: { participantCount: 30, roomCount: 2, topology: "한 게임에서 팀마다 참가 링크를 만들어 두 방에 나눠 줌", participantRoles: ["진행자 1명", "방 안내자 2명", "참가자 30명"], setupInstructions: ["진행자가 5명씩 6팀을 만든다.", "각 방에 3개 팀 링크를 공유한다.", "전체 동시 시작을 사용한다."], contingency: "실시간 연결이 불안하면 방마다 다른 통신망을 쓰고 기존 참가 권한으로 다시 연결한다." },
